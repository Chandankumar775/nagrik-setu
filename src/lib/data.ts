...
const mockReports: Report[] = [
    ...
    // 3 (Acknowledged)
    { id: 'rep-mock-3', trackingId: 'CC-MOCK-3', category: 'Overflowing Trash Bin', description: 'Community trash bin near the temple in Varanasi has not been emptied for a week.', location: { lat: 25.3176, lng: 82.9739 }, address: 'Near Kashi Vishwanath Temple, Varanasi, Uttar Pradesh', status: 'Acknowledged', isUrgent: false, photoUrl: 'https://picsum.photos/seed/mock3/400/300', submittedAt: new Date('2024-07-20T11:45:00Z'), updatedAt: new Date('2024-07-20T16:00:00Z') },
    // 4 (Resolved)
    { id: 'rep-mock-4', trackingId: 'CC-MOCK-4', category: 'Water Leak', description: 'Clean water pipe is leaking heavily on the main road in Jaipur.', location: { lat: 26.9124, lng: 75.7873 }, address: 'Hawa Mahal Road, Jaipur, Rajasthan', status: 'Resolved', isUrgent: true, photoUrl: 'https://picsum.photos/seed/mock4/400/300', submittedAt: new Date('2024-07-12T08:00:00Z'), updatedAt: new Date('2024-07-13T17:00:00Z') },
    // 5 (Submitted)
    { id: 'rep-mock-5', trackingId: 'CC-MOCK-5', category: 'Other', description: 'Stray dogs are causing issues in the residential area of Sector 17.', location: { lat: 30.7415, lng: 76.7766 }, address: 'Sector 17, Chandigarh', status: 'Submitted', isUrgent: false, photoUrl: 'https://picsum.photos/seed/mock5/400/300', submittedAt: new Date(), updatedAt: new Date() },
    // 6 (Resolved)
    { id: 'rep-mock-6', trackingId: 'CC-MOCK-6', category: 'Pothole', description: 'Series of potholes on the road to the IT park.', location: { lat: 12.9716, lng: 77.5946 }, address: 'Electronic City, Bengaluru, Karnataka', status: 'Resolved', isUrgent: false, photoUrl: 'https://picsum.photos/seed/mock6/400/300', submittedAt: new Date('2024-07-01T10:00:00Z'), updatedAt: new Date('2024-07-08T12:00:00Z') },
    // 7 (Resolved)
    { id: 'rep-mock-7', trackingId: 'CC-MOCK-7', category: 'Traffic Signal Malfunction', description: 'The traffic signal at the main Chennai crossing is stuck on green, very dangerous.', location: { lat: 13.0827, lng: 80.2707 }, address: 'Anna Salai, Chennai, Tamil Nadu', status: 'Resolved', isUrgent: true, photoUrl: 'https://picsum.photos/seed/mock7/400/300', submittedAt: new Date('2024-07-19T18:00:00Z'), updatedAt: new Date('2024-07-19T20:30:00Z') },
    // 8 (Resolved)
    { id: 'rep-mock-8', trackingId: 'CC-MOCK-8', category: 'Overflowing Trash Bin', description: 'Garbage overflowing at Marina Beach entrance.', location: { lat: 13.0500, lng: 80.2824 }, address: 'Marina Beach, Chennai, Tamil Nadu', status: 'Resolved', isUrgent: false, photoUrl: 'https://picsum.photos/seed/mock8/400/300', submittedAt: new Date('2024-07-14T13:00:00Z'), updatedAt: new Date('2024-07-16T11:00:00Z') },
    // 9 (Rejected)
    { id: 'rep-mock-9', trackingId: 'CC-MOCK-9', category: 'Other', description: 'My neighbour plays loud music. Please tell them to stop.', location: { lat: 28.6139, lng: 77.2090 }, address: 'Connaught Place, New Delhi, Delhi', status: 'Rejected', isUrgent: false, photoUrl: 'https://picsum.photos/seed/mock9/400/300', submittedAt: new Date('2024-07-21T19:00:00Z'), updatedAt: new Date('2024-07-21T19:30:00Z') },
    // 0 -> 10 (Rejected)
